  ...
  ja: {
    ...
    projects: {
      ...
      desc: {
        ...
        myvaravuselavu: '個人向け家計管理PWA。円建て・ルピー建ての収支と日本→インドの送金を通貨を混同せず記録し、交通費精算、割り勘、給与明細の解析、自然文の「クイック追加」も対応。オプトインのGemini機能（対話式入力、レシート・給与明細の読み取り、音声インサイト）はAIが金額を計算しない設計に限定 — 数値はすべてローカルで算出し、1,500件超のテストで検証。',
